...
return [
	...
	[
		...
		'fields'  => [
			...
			[
				'label'   => __( 'Suggested age', 'slim-seo-schema' ),
				'id'      => 'suggestedAge',
				'std'     => '{{ product.variants.suggested_age }}',
				'tooltip' => __( 'The suggested age of the product.', 'slim-seo-schema' ),
			],
			[
				'label'   => __( 'Suggested gender', 'slim-seo-schema' ),
				'id'      => 'suggestedGender',
				'std'     => '{{ product.variants.suggested_gender }}',
				'tooltip' => __( 'The suggested gender of the product.', 'slim-seo-schema' ),
			],
			[
				'label'   => __( 'Material', 'slim-seo-schema' ),
				'id'      => 'material',
				'std'     => '{{ product.variants.material }}',
				'tooltip' => __( 'The material of the product.', 'slim-seo-schema' ),
			],
			[
				'label'   => __( 'Pattern', 'slim-seo-schema' ),
				'id'      => 'pattern',
				'std'     => '{{ product.variants.pattern }}',
				'tooltip' => __( 'The pattern of the product.', 'slim-seo-schema' ),
			],
			[
	...
	[
		...
		'required' => true,
		'options'  => [
			'https://schema.org/color'           => __( 'Color', 'slim-seo-schema' ),
			'https://schema.org/size'            => __( 'Size', 'slim-seo-schema' ),
			'https://schema.org/suggestedAge'    => __( 'Suggested age', 'slim-seo-schema' ),
			'https://schema.org/suggestedGender' => __( 'Suggested gender', 'slim-seo-schema' ),
			'https://schema.org/material'        => __( 'Material', 'slim-seo-schema' ),
			'https://schema.org/pattern'         => __( 'Pattern', 'slim-seo-schema' ),
		],
	],
