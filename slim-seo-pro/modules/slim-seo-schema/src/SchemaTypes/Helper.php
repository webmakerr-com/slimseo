...
class Helper {
	public static function get_property( $name, $args = [] ) {
		...
		$properties['QuantitativeValue'] = [
			'fields' => [
				...
				[
					'id'      => 'unitCode',
					'label'   => __( 'Unit code', 'slim-seo-schema' ),
	...
	public static function get_sub_type( string $name, array $args = [] ): array {
		$spec = include __DIR__ . "/SubTypes/$name.php";
		return array_replace_recursive( $spec, $args );
	}
}
